        ...
        <tr>
          ...
          <td>
            <div class="btn-group btn-group-sm">
              <a class="btn btn-outline-secondary" href="admin-view-document.php?id=<?php echo (int)$d['id']; ?>" title="Vezi">
                <i class="bi bi-eye"></i>
              </a>
              <a class="btn btn-outline-success" href="admin-download.php?id=<?php echo (int)$d['id']; ?>" title="Descarcă">
                <i class="bi bi-download"></i>
              </a>
              <a class="btn btn-outline-info" href="admin-print.php?id=<?php echo (int)$d['id']; ?>" target="_blank" title="Print">
                <i class="bi bi-printer"></i>
              </a>
              <a class="btn btn-outline-warning" href="admin-edit-document.php?id=<?php echo (int)$d['id']; ?>" title="Editează">
                <i class="bi bi-pencil"></i>
              </a>
              <a class="btn btn-outline-danger" href="admin-delete.php?id=<?php echo (int)$d['id']; ?>" 
